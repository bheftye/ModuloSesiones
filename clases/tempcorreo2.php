...
class tempcorreo2 extends correo
{
	var $correo2;
	var $cliente;
	var $boletin;
	...
	function tempcorreo2($idcorreo2,$idcliente,$idboletin, $correoPrueba="")
    {
		$this->correo();    
     	$this->correo2=new correo2($idcorreo2);
		$this->correo2->obtenerCorreo2();
		$this->correo2->listarCorreo2img();
		$this->correo2->listarCorreo2img2();
    ...
    {
        $this->correo->Subject=$this->correo2->titulo;//este es de datos_usuario y nomusuario es de usuario
    }
		...
		<td width="100%" valign="top" bgcolor="#ffffff" style="padding-top:20px">
			...
			<table width="580" border="0" cellpadding="0" cellspacing="0" align="center" class="deviceWidth">
				<tr>
					...
					foreach ($this->correo2->correo1img as $elemento1) {
						$this->correo->Body.= '<table width="49%" border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                            <tr>
                                <td align="center">                               
                                    <p style="mso-table-lspace:0;mso-table-rspace:0; margin:0"><img width="267" src="http://clientes.locker.com.mx/patadeperro/panel/correos/correo2/correo1img/'.$elemento1['ruta'].'" alt="" border="0" style="border-radius: 4px; width: 267px" class="deviceWidth" /></p>
                                </td>
                            </tr>                       
                        </table>  ';
					}
				...
				<tr>
					<td class="center" style="padding:10px 0 0 5px">
                       ...
                       <table width="49%" border="0" cellpadding="0" cellspacing="0" align="left" class="deviceWidth">
                            <tr>
                                <td align="center">
                                    <p style="mso-table-lspace:0;mso-table-rspace:0; margin:0"><img width="267" src="http://clientes.locker.com.mx/patadeperro/panel/correos/correo2/'.$this->correo2->ruta.'" alt="" border="0" style="border-radius: 4px; width: 267px" class="deviceWidth" /></p>
                                </td>
                            </tr>                      
                        </table>  
			...
			<table width="580" class="deviceWidth" border="0" cellpadding="0" cellspacing="0" align="center">
				<tr>
					<td valign="top" style="padding:0" bgcolor="#ffffff">
						<img  class="deviceWidth" src="http://clientes.locker.com.mx/patadeperro/panel/correos/correo2/correo2img/'.$this->correo2->correo2img[0]['ruta'].'" width="580" height="200" alt="" border="0" style="display: block; border-radius: 4px;" />						
					</td>
				</tr>          
			</table><!-- End One Column -->
