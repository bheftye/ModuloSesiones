...
if(isset($_REQUEST['idtip'])){
	$id=$_REQUEST['idtip'];
	$operacion='modificartip';
	$palabra='Editar Tip';
	$temporal = new Tip($id);
	$temporal -> obtenerTip();
	
	if($temporal->imgPrincipal != ''){
		$img = '<img src="../tips/principales/'.$temporal->imgPrincipal.'" width="auto" height="221"/>';
    }
	else 
		$img='';
	if($temporal->imgPrincipal != ''){
                ...
                <div class="row rowedit">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    	<form id="form-validation" name="form1" action="operaciones.php" method="post" onsubmit="return validar_campos()" enctype="multipart/form-data">
                    		...
                    		<input type="hidden" name="idtip" value="<?=$temporal->idTip?>"/>
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
                        ...
                        <br>
                        <span class="textHelper">Ingrese la descripción del tip</span>
								...
								foreach ($temporal->imgSecundarias as $elementoImgS) {
								  echo '<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12" id="img2'.$elementoImgS -> idImgS.'">
								  			<div class="image-wrapper">
								  				...
								  				<img style="margin: 0 0 20px 0" class="img-responsive" src="../tips/secundarias/'.$elementoImgS -> ruta.'"/>
											</div>												
										</div>';
								}
     						}
 ...
 <!--Script que sirve para validar-->
	...
	function validar_campos(){
		...
		if (form1.titulo.value == ''){
			...
			$('.top-right').notify({
    			message: { text: 'El Campo del titulo esta vacío, para poder continuar asigne un titulo al tip.' },
    			type:'blackgloss',
  			}).show();
			return false;
			}
...
<script>
	function deleteIMG2(id){
		...
		$.ajax({
			...
			url:"operaciones.php",
			data:"idImg2="+id+"&operaciones=eliminarImgTip",
...
$(function() {
	...
	{
		placement: "top",
        title: "Ingrese el subtitulo del tip aquí."
	});
	
	$('#files').tooltip(
	{
		placement: "top",
        title: "Campo Requerido. Agregue la imagen principal de este tip, solo se aceptan imágenes con formato .jpg, .png y .gif ."
	});
});
</script>
</html>
