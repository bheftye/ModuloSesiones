                          ...
                          <table class="table table-hover table-striped tablesorter">
                            <thead class="styled-thead">
                              <tr>
                                ...
                                <th width="100">Nombre <i class="fa fa-sort"></i></th>
                                <th class="text-center">Tipo <i class="fa fa-sort"></i></th>
               	...
               	<?php
                 	foreach ($listaUsuario as $elemento) {
						...
						echo  '<tr>
                                ...
                                <td class="text-center visible-lg visible-md">'.$elemento['nomtipo'].'</td>
                                <td class="text-center visible-lg visible-md"><img class="manita" onclick="'.$funcion.'" id="temp'.$elemento['idusuario'].'" src="'.$img.'"></td>
                              </tr>';
					}
         		?>	       
         					</form>                
                            ...
                            <tfoot class="styled-tfoot">
                              <tr>
                                ...
                                <th class="text-center visible-lg visible-md">Tipo</th>
                                <th class="text-center visible-lg visible-md">Mostrar</th>
                              </tr>
                            </tfoot>
                          </table>
