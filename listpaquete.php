...
$paquete = new Paquete();
$listaPaquete = $paquete -> listarPaquetes();
$clave='AgrPqt';
$clave2='ElimPqt';
$clave3='AcDcPqt';
?>
            ...
            <div class="page-content inset">
                <div class="row rowedit">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        <p class="titulo">Paquetes</p>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">                    	
                    	<form action="formpaquete.php" method="post">
                    ...
                    <div class="styled-large">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <ul class="ulfiltros">
                                ...
                                <li class="lifiltros">    
                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operapaquete">Aplicar</button>
                                </li>
                            ...
                            <div class="busqueda"><input type="text" onkeyup="buscarPaquetePorPalabra(this.value)" class="form-control search" placeholder="Buscar..."></div>                        
                        </div>
                          ...
                          <table class="table table-hover table-striped tablesorter">
                            <thead class="styled-thead">
                              <tr>
                                ...
                                <th class="text-center visible-lg visible-md">Precio</th>
               	...
               	<?php
                 	foreach ($listaPaquete as $elemento) {
                 			if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
								...
								if($elemento -> status!=0){
									$img='img/visible.png';
									$funcion='Desactivar('.$elemento -> idPaquete.')';
								}
								else{
							  		$img='img/invisible.png';
									$funcion='Activar('.$elemento -> idPaquete.')';
							   }
							}		
						...
						echo  '<tr>
                              	<td>
                                	<input type="checkbox" id="'.$elemento -> idPaquete.'" name="idpaquete[]" value="'.$elemento -> idPaquete.'">
									<label for="'.$elemento -> idPaquete.'"><span></span></label>
                                </td>
                                <td>'.$elemento -> idPaquete.'</td>
                                <td><a href="formpaquete.php?idpaquete='.$elemento -> idPaquete.'">'.$elemento -> titulo.'</a></td>
                                <td class="text-center visible-lg visible-md">'.$elemento -> precio.'</td>
                                <td class="text-center visible-lg visible-md">'.$elemento -> vigencia.'</td>
                                <td class="text-center visible-lg visible-md"><img class="manita" onclick="'.$funcion.'" id="temp'.$elemento -> idPaquete.'" src="'.$img.'"></td>
                              </tr>';
					}
         		?>	       
         					</form>                
...
<script>
	function Activar(id){
		...
		$.ajax({
			...
			url:"operaciones.php",
			data:"id="+id+"&operaciones=activapaquete",
	...
	function Desactivar(id){
		...
		$.ajax({
			...
			contentType: "application/x-www-form-urlencoded",
			url:"operaciones.php",
			data:"id="+id+"&operaciones=desactivapaquete",
			success:function(data){				
