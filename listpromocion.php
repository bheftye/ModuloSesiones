...
$listaPromocion = $promocion -> listarPromociones();
$clave='AgrPromocion';
$clave2='ElimPromocion';
$clave3='AcDcPromocion';
?>
<?php
        ...
        <div id="page-content-wrapper">
            ...
            <div class="page-content inset">
                <div class="row rowedit">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">                    	
                    	<form action="formpromocion.php" method="post">
                    ...
                    <div class="styled-large">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <ul class="ulfiltros">
                                ...
                                <li class="lifiltros">    
                                    <button type="submit" class="buttonaplicar" name="operaciones" value="operapromocion">Aplicar</button>
                                </li>
                            ...
                            <div class="busqueda"><input type="text" onkeyup="buscarPromocionPorPalabra(this.value)" class="form-control search" placeholder="Buscar..."></div>                        
                        </div>
               	...
               	<?php
                 	foreach ($listaPromocion as $elemento) {
                 			if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
								...
								if($elemento -> status!=0){
									$img='img/visible.png';
									$funcion='Desactivar('.$elemento -> idPromocion.')';
								}
								else{
							  		$img='img/invisible.png';
									$funcion='Activar('.$elemento -> idPromocion.')';
							   }
							}		
						...
						echo  '<tr>
                              	<td>
                                	<input type="checkbox" id="'.$elemento -> idPromocion.'" name="idpromocion[]" value="'.$elemento -> idPromocion.'">
									                <label for="'.$elemento -> idPromocion.'"><span></span></label>
                                </td>
                                <td>'.$elemento -> idPromocion.'</td>
                                <td><a href="formpromocion.php?idpromocion='.$elemento -> idPromocion.'">'.$elemento -> titulo.'</a></td>
                                <td class="text-center visible-lg visible-md"><img class="manita" onclick="'.$funcion.'" id="temp'.$elemento -> idPromocion.'" src="'.$img.'"></td>
                              </tr>';
					}
         		?>	       
         					</form>                
  ...
  $.ajaxSetup({ cache: false });
	...
	function Activar(id){
		...
		$.ajax({
			...
			url:"operaciones.php",
			data:"id="+id+"&operaciones=activapromocion",
	...
	function Desactivar(id){
		...
		$.ajax({
			...
			contentType: "application/x-www-form-urlencoded",
			url:"operaciones.php",
			data:"id="+id+"&operaciones=desactivapromocion",
			success:function(data){				
