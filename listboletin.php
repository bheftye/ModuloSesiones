...
$listaTemporal = $temporal -> listarBoletin();
$clave='AgrBol';
$clave2='ElimBol';
$clave3='AcDcBol';
?>
...
?>
	<title>Listado De Los Boletines</title>
<?php
                ...
                <div class="row rowedit">
                    ...
                    <div class="styled-large">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="busqueda"><input type="text" onkeyup="buscarPorPalabraBoletin(this.value)" class="form-control search" placeholder="Buscar..."></div>                        
                        </div>
                    ...
                    <div class="col-lg-12">
                          ...
                          <table class="table table-hover table-striped tablesorter">
                            <thead class="styled-thead">
                              <tr>
                                ...
                                <th>Correo Electrónico <i class="fa fa-sort"></i></th>                               
						...
						foreach($listaTemporal as $elementoTemporal)
						{
							if($seguridad->valida_permiso_usuario($_SESSION['idusuario'],$clave3)==0){
								...
								if($elementoTemporal-> status!=0){
									$img='img/visible.png';
									$funcion='Desactivar('.$elementoTemporal-> idBoletin.')';
								}
								else{
							  		$img='img/invisible.png';
									$funcion='Activar('.$elementoTemporal-> idBoletin.')';
							   }
							}
						 echo'<tr>
                              	<td>
                                	<input type="checkbox" id="'.$elementoTemporal-> idBoletin.'" name="idboletin[]" value="'.$elementoTemporal-> idBoletin.'">
									<label for="'.$elementoTemporal-> idBoletin.'"><span></span></label>
                                </td>
                                <td>'.$elementoTemporal-> correo.'</td>                                               
                                <td class="text-center visible-lg visible-md"><img class="manita" onclick="'.$funcion.'" id="temp'.$elementoTemporal-> idBoletin.'" src="'.$img.'"></td>
                              </tr>';
						}
                        ?>
                        	</form>
...
<script>
	function Activar(id){
		...
		$.ajax({
			...
			url:"operaciones.php",
			data:"id="+id+"&operaciones=activaboletin",
	...
	function Desactivar(id){
		...
		$.ajax({
			...
			contentType: "application/x-www-form-urlencoded",
			url:"operaciones.php",
			data:"id="+id+"&operaciones=desactivaboletin",
			success:function(data){				
